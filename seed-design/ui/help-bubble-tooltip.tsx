...
export interface HelpBubbleTooltipDelayGroupProps
  extends SeedHelpBubbleTooltip.DelayGroupProps {}
...
>(
  (
    { title, description, contentProps, zIndexOffset, children, ...otherProps },
    ref,
  ) => {
    return (
        ...
        >
          <SeedHelpBubbleTooltip.Content {...contentProps}>
            ...
            <SeedHelpBubbleTooltip.Body>
              ...
              {description && (
                <SeedHelpBubbleTooltip.Description>
                  {description}
                </SeedHelpBubbleTooltip.Description>
              )}
            </SeedHelpBubbleTooltip.Body>
