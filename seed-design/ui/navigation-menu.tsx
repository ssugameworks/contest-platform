...
export interface NavigationMenuProviderProps
  extends SeedNavigationMenu.ProviderProps {}
...
export interface NavigationMenuTriggerProps
  extends SeedNavigationMenu.TriggerProps {}

export const NavigationMenuTrigger = SeedNavigationMenu.Trigger;

export interface NavigationMenuContentProps
  extends SeedNavigationMenu.ContentProps {
  ...
  return (
    <SeedNavigationMenu.Item ref={ref} {...props}>
      ...
      <SeedNavigationMenu.ItemBody>
        ...
        {description && (
          <SeedNavigationMenu.ItemDescription>
            {description}
          </SeedNavigationMenu.ItemDescription>
        )}
      </SeedNavigationMenu.ItemBody>
